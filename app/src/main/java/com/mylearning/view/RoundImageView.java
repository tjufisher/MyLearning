...
public class RoundImageView extends ImageView {
    ...
    public RoundImageView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mBorderThickness = a.getDimensionPixelSize(
                R.styleable.RoundImageView_roundThickness, 0);
        mBorderOutsideColor = a.getColor(R.styleable.RoundImageView_outsideRoundColor,
                defaultColor);
        mBorderInsideColor = a.getColor(R.styleable.RoundImageView_insideRoundColor, defaultColor);
